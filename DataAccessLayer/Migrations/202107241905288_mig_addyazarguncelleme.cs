namespace DataAccessLayer.Migrations
{
    ...
    public partial class mig_addyazarguncelleme : DbMigration
    {
        public override void Up()
        {
            AddColumn("dbo.Authors", "AuthorTitle", c => c.String(maxLength: 200));
            AddColumn("dbo.Authors", "AboutShort", c => c.String(maxLength: 200));
